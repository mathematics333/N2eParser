...
```mermaid
   graph TD;
       ExportViewpointsToXML-->SaveAs_NwInPut.xml-->Run_N2E-->A_NwOutput.xlsx_getsGenerated-->ViewpointNames_autoCopied_intoAccTemplate-->CompleteTemplateInformationAccordingly-->import_AccTemplate_intoAccWebApp;
